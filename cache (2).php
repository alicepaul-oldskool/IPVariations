...
<html>
<head>
<title>Example: Abstractness vs. Concreteness</title>
</head>
<body>
<header>
<div class="container">
...
<div id="content">  
<header><h3>Example: Abstractness vs. Concreteness</h3></header>
...
<input type="hidden" name="num_tries" value="<?php echo $num_tries; ?>" />
    <input type="submit" name="submit" id="submit" value="submit" src="assets/next_o.png" width="20" height="20">
    <sup> continue</sup></p></div>
</form>
<?
if($_POST['submit'])
{ 
