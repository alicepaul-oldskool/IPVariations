...
<!--<a href="ac_2.php" class="transition">LINK</a>-->
  <header><span class="bold_text">Instructions</span>: Abstractness vs. Concretenes 
    <!-- en<d .sidebar1 --><br>
...
<br>
<br>
<div id="submit"><a href="ac_4.php" class="transition"><img src="assets/next_o.png" width="19" height="19" alt="continue"></a>  <sup> NEXT</sup>
</div>
</div>
</div></div></body>
</html>