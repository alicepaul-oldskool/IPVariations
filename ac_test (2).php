...
if ($_POST["num_tries"]> $_SESSION['testing_counter'])
{
	header("Location:test_done1.php");
}
...
<form id="survey" method="post" name="survey" action="<?php echo $_SERVER["PHP_SELF"]; ?>" onSubmit="<?php echo $_SERVER["PHP_SELF"]; ?>">
<p>&nbsp;</p>
<p>&nbsp;</p>
