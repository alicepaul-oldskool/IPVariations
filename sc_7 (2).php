...
<div class="underline-big">Guidlines For Ratings</div>
        <strong>
<span class="bold_text">SIMPLE</span></span>   </strong><br>

        
     <span class="underline">Very simple: </span>images typically have less elements in the composition and might be characterized as "basic". <br>
     <br>

 <div id="one">
   <p><span class="bold_text">COMPLEX</span><br>
     <span class="underline">Very complex:</span> images typically have more elements in the compostion and might be characterized as "busy" or mo<br>
   </p>
   <div id="submit"><a href="sc_training.php" class="transition"><img src="assets/next_o.jpg" width="19" height="19" alt="continue"></a>  <sup> Continue</sup>
</div>
</div>
</div>
</div></div></body>
