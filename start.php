...
<div class="container">
	<div id="content">
		<header><h3>Abstractness vs. Concreteness</h3></header>
			<section>       
            <?php echo 'acounter:'.$_SESSION['ac_counter'];?>
        		<form id="survey" method="post"  action="" onSubmit="<?php $session['ac_counter']-1;?>">
<p><?php // echo $current_question_number; ?></p>
     ...
     <div id="controls">
           	  <input type="hidden" name="answer" value='0' />
                  ...
                  <input name="button" type="button"value="click me" onClick="<?php countdown();?>">
...
<div align="center"></div>
  <input type="image" name="submit" id="continue" value="Start"  src="assets/next_o.png" width="20" height="20">
