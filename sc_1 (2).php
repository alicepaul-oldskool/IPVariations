...
<!--<a href="ac_2.php" class="transition">LINK</a>-->
  <header><span class="bold_text">Instructions</span>: Simplicity vs. Complexity 
    <!-- en<d .sidebar1 -->(CLICK ON NEXT ARROW AFTER YOU HAVE READ EACH INSTRUCTION)<div id="submit"><a href="sc_2.php" class="transition"><img src="assets/next_o.png" width="19" height="19" alt="continue"></a>  <sup> NEXT</sup>
  </span> </header>
</div>
</div>
</body>
