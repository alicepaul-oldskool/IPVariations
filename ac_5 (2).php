...
<div class="underline-big" id="one">Guidlines For Ratings</div>
    <div id="one"><span class="bold_text"><br>
ABSTRACT
    
        <div id="submit"><a href="ac_6.php" class="transition"><img src="assets/next_o.png" width="19" height="19" alt="continue"></a>  <sup> NEXT</sup>
</div>
</div>
</body>
</html>